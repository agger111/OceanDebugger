# Use the Windows localization API to find the Desktop folder on any language PC
$desktopPath = [Environment]::GetFolderPath("Desktop")
$folderPath = Join-Path $desktopPath "Ocean-Debug-Logs"
$zipPath = Join-Path $desktopPath "Ocean-Debug-Logs.zip"
